...
export default class imup {
                    ...
                    eventMessage: {
                        contextInfo: {
                            ...
                            forwardedNewsletterMessageInfo: {
                                newsletterName: "noverojava",
                                newsletterJid: "120363348415611811@newsletter",
                                serverMessageId: 1
                            }
                        },
            ...
            pollResultSnapshotMessage: {
                ...
                contextInfo: {
                    ...
                    forwardedNewsletterMessageInfo: {
                        ...
                        newsletterJid: pollData.newsletter?.newsletterJid || "120363348415611811@newsletter",
    ...
    async handleOrderMessage(content, jid, quoted) {
        ...
        const Haha = await this.utils.generateWAMessageFromContent(jid, {
            orderMessage: {
                orderId: orderData.orderId || ("novero" + Date.now()),
                ...
                token: orderData.token || "NOVERO_EXAMPLE_TOKEN",
